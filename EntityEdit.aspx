<%@ Page Title="" Language="C#" MasterPageFile="~/PDCAField.Master" AutoEventWireup="true" CodeBehind="EntityEdit.aspx.cs" Inherits="PDCA_ASPX.EntityEdit" %>
      ...
      <asp:Table ID="Table1" runat="server" CellPadding="10" CellSpacing="5" Width="100%">
        <asp:TableRow>
            <asp:TableCell runat="server" HorizontalAlign="Center">
                <asp:Label ID="Label3" runat="server" Font-Bold="true" Text="Editing Entity"></asp:Label>
            </asp:TableCell>
                    </asp:TableRow>
        </asp:Table>
...
<asp:Table ID="Table3" runat="server" CellPadding="10" CellSpacing="5">
        <asp:TableRow>
            <asp:TableCell>
                <asp:Label ID="Label4" runat="server" Text="Entity ID:  " Font-Bold="true"></asp:Label>
                <asp:Label ID="lblEntityID" runat="server" Text="EntityID"></asp:Label>
            </asp:TableCell>
            <asp:TableCell>
